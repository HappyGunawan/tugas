...
<div id="isi_content">
<?php
	$sql="SELECT t_nilai.*,t_mahasiswa.nama,t_mata_kuliah.nama_mk FROM t_nilai INNER JOIN t_mahasiswa ON t_nilai.nim=t_mahasiswa.nim INNER JOIN t_mata_kuliah ON t_nilai.kd_mk=t_mata_kuliah.kd_mk WHERE t_mahasiswa.nama LIKE '%".$_POST['txtcari']."%' ";
